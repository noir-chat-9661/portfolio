			...
			<div className="min-h-[calc(100dvh-var(--spacing)*16)] flex items-center content-center justify-center text-center flex-col relative">
				<div
					className={cn(
						...
						isMounted ? "opacity-100 translate-y-0" : "-translate-y-50 opacity-0",
					)}
				>
				...
				<button
					...
					className={cn(
						"absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all duration-300 cursor-pointer select-none animate-bounce",
						isMounted ? "opacity-100" : "opacity-0",
					)}
					aria-label="Scroll down"
				>
					<span className="text-sm font-medium">{isMounted ? "Scroll Down" : <>&nbsp;</>}</span>
