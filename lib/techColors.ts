export const techColors: Record<string, string> = {
	...
	Brainfuck: "bg-purple-300 dark:bg-purple-600 text-purple-800 dark:text-purple-300",
	...
	Preact: "bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200",

	"Tailwind CSS": "bg-teal-200 dark:bg-teal-800 text-teal-800 dark:text-teal-200",
