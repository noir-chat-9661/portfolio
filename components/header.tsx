...
import { House, Link, User } from "lucide-react";
	...
	return (
		...
		>
			<div className="absolute left-4 top-1/2 transform -translate-y-1/2 flex items-center">
				...
				/>
				<div className="text-xl font-bold lg:block hidden">
					{isMounted ? t("header.title") : <>&nbsp;</>}
				</div>
			</div>
			...
			<div className="absolute right-4 sm:right-8 top-1/2 transform -translate-y-1/2 flex items-center gap-2 sm:gap-5 flex flex-col items-center xs:flex-row">
				<LangButton />
				<ThemeButton />
			</div>
		</header>
